...
def get_data(query):
    if query == 'Daily_2023':
        return pd.read_csv('Data\Domestic\Y23\Y23-Daily.csv')
    elif query == 'Weekly_2023':
        return pd.read_csv('Data\Domestic\Y23\Y23-Weekly.csv')
    elif query == 'daily_table':
        return pd.read_csv('Data\Domestic\Y23\Y23-Daily2.csv')
    return None
